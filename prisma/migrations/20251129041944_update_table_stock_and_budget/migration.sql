/*
  ...
  - You are about to drop the column `stockQuantity` on the `Budget` table. All the data in the column will be lost.
  - Added the required column `quantityUsage` to the `Budget` table without a default value. This is not possible if the table is not empty.

*/
-- AlterTable
ALTER TABLE "Stock" ADD COLUMN "costTotal" REAL;
ALTER TABLE "Stock" ADD COLUMN "costUnit" REAL;
...
INSERT INTO "new_Budget" ("Userfunction", "allocatedStage", "code", "cost", "createdAt", "extraHours", "hours", "id_budget", "id_category", "id_stage", "id_substage", "id_type", "id_work", "name", "total", "unitMeasure", "updatedAt", "weightLength") SELECT "Userfunction", "allocatedStage", "code", "cost", "createdAt", "extraHours", "hours", "id_budget", "id_category", "id_stage", "id_substage", "id_type", "id_work", "name", "total", "unitMeasure", "updatedAt", "weightLength" FROM "Budget";
DROP TABLE "Budget";
